...
const checkboxItems = [
  "אני מתחיל חזק ואז נעלם אחרי שבוע.",
  'אני "מבין כושר", אבל הגוף לא נראה בהתאם.',
  "אני מחכה למוטיבציה ואז מתבאס שאין.",
  "אני טוב בלהגיד לאחרים מה לעשות, פחות טוב בלבצע בעצמי.",
  "שבוע אחד טוב ושבוע אחד אני מתרסק.",
];
    ...
    <SectionWrapper>
      <div className="text-center mb-10">
        ...
        <p className="text-muted-foreground text-lg">
          תסמן מה נכון לגביך. זה לא שיפוט. זה אבחון.
        </p>
      </div>
            ...
            >
              {checked[i] && (
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <path d="M2 6L5 9L10 3" stroke="hsl(0,0%,7%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              )}
            </div>
      ...
      >
        ...
        <p className="text-foreground mb-3">
          זה לא "אופי". זה מנגנון. מחליפים מנגנון, לא מאשימים את עצמנו.
        </p>
        <p className="text-primary text-sm font-semibold mb-6">
          התוצאה לא מגיעה כשנוח. היא מגיעה כשיש שיטה.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <Button variant="gold" size="lg" onClick={scrollToForm}>
            בדיקת התאמה בחינם
          </Button>
          <span className="text-muted-foreground text-sm">5 דקות. בלי חפירות.</span>
        </div>
      </div>
    </SectionWrapper>
  );
