...
const checkboxItems = [
  ...
  "אני מבין מה צריך לעשות, אבל הגוף לא נראה בהתאם.",
  "אני מחכה למוטיבציה ואז מתבאס כשהיא לא מגיעה.",
  "אני טוב בלייעץ לאחרים, פחות טוב בלבצע בעצמי.",
  "יש לי שבוע טוב, ואז שבוע שאני מתרסק בו.",
];
